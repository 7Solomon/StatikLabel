    ...
    for pol_pair in pole_ordered_per_scheibe:
        if pol_pair[1] == 0:   ## Hauptpol
            ...
            #    pass     
                ...
                check_if_WL_and_point_meet(test_1, test_2, node_data)
                return True
...
def analyze_polplan(pol_data, node_data):
    ...
    print('Analyzing polplan system and sort pole to scheiben...')
    ...
    print('Checking Single Scheiben...')
    for scheibe, pole in pols_of_same_scheibe.items():
        print(f'Checking Scheibe {scheibe}...')
